<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Host.aspx.cs" Inherits="CloudForensics.Host" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content" class="app-content">
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Host Machines</li>
        </ul>

        <h1 class="page-header">Manage Host Machines 
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="form-group mb-3">
                            <label class="form-label" for="txtSystem">System</label>
                            <asp:TextBox runat="server" ID="txtSystem" CssClass="form-control" ValidationGroup="Validate" />
                            <asp:HiddenField runat="server" ID="hid" />
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtSystem" ValidationGroup="Validate" ErrorMessage="This field is required." SetFocusOnError="true" ForeColor="#c35153" />
                        </div>
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label" for="txtSerial">Serial</label>
                                ...
                                <td>
                                    ...
                                    <ul class="list-inline m-0">
                                        ...
                                        <li class="list-inline-item">
                                            <asp:LinkButton runat="server" ID="edit" CommandName="Edit" Text="Add Rev." CommandArgument='<%#Eval("HOST_ID") %>' class="btn btn-success btn-sm rounded-0" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></asp:LinkButton>
                                            <asp:LinkButton runat="server" ID="LinkButton1" OnClientClick="return confirm('Are you sure you want to delete this item?');" CommandName="Delete" Text="Delete" CommandArgument='<%#Eval("HOST_ID") %>' class="btn btn-danger btn-sm rounded-0" data-toggle="tooltip" data-placement="top" title="delete"><i class="fa fa-trash"></i></asp:LinkButton>
